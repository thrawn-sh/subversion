...
final class Helper {
	...
	private static final URI DUMP_URI = URI.create("http://10.155.50.104/dump.zip");

	private static final String PASSWORD = "svnpass";

	private static final URI REPOSITORY_URI = URI.create("http://10.155.50.104/svn-basic/test");
