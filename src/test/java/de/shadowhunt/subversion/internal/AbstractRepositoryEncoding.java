...
public abstract class AbstractRepositoryEncoding {
    ...
    protected AbstractRepositoryEncoding(final Repository repository, final UUID testId, final File root) {
    ...
    public void test04_add_01_Utf8File() throws Exception {
        AbstractRepositoryAdd.file(repository, write.append(Resource.create("/add_日本国.txt")), "A", true);
    }

    @Test
    public void test04_add_02_XmlFile() throws Exception {
        AbstractRepositoryAdd.file(repository, write.append(Resource.create("/add_<&>'\".txt")), "A", true);
    }

    @Test
    public void test04_add_03_UrlFile() throws Exception {
        AbstractRepositoryAdd.file(repository, write.append(Resource.create("/add ^%.txt")), "A", true);
    }

    @Test
    public void test04_add_04_CombinedFile() throws Exception {
        AbstractRepositoryAdd.file(repository, write.append(Resource.create("/add_日本国_<&>'\"_ ^%.txt")), "A", true);
    }
    ...
    private void testDelete(final Resource resource) throws Exception {
        AbstractRepositoryAdd.file(repository, resource, "A", true);
        final Transaction transaction = repository.createTransaction();
        try {
    ...
    private void testDownload(final Resource resource, final Revision revision) throws Exception {
        ...
        AbstractRepositoryDownload.assertEquals(message, expected, repository.download(resource, revision));
    }
    ...
    private void testList(final Resource resource, final Revision revision, final Depth depth) throws Exception {
        ...
        AbstractRepositoryList.assertListEquals(message, expected, repository.list(resource, revision, depth));
    }
