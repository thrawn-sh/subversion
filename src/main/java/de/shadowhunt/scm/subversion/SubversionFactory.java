...
public final class SubversionFactory {
	...
	public static final SubversionRepository getInstance(final URI root, @Nullable final String user, final String password, @Nullable final String workstation, final ServerVersion version) {
		final SubversionRepository reposiotry;
		switch (version) {
			case V1_6:
				reposiotry = new SubversionRepository1_6(root);
				break;
			case V1_7:
				reposiotry = new SubversionRepository1_7(root);
				break;
			default:
