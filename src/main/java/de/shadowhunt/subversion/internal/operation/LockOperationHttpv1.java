...
public class LockOperationHttpv1 extends AbstractRepositoryBaseOperation<RepositoryInternal, Void> {

    private final QualifiedResource qualifiedResource;

    private final boolean stealLock;

    public LockOperationHttpv1(final RepositoryInternal repository, final QualifiedResource qualifiedResource, final boolean stealLock) {
