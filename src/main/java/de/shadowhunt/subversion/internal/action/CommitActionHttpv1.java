...
public class CommitActionHttpv1 implements Action<Void> {
    ...
    public CommitActionHttpv1(final RepositoryInternal repository, final TransactionInternal transaction, final String message, final boolean releaseLocks) {
