...
public class MkdirActionHttpv1 implements Action<Void> {
    ...
    public MkdirActionHttpv1(final RepositoryInternal repository, final TransactionInternal transaction, final Resource rootResource, final boolean createMissingParents) {
    ...
    private void checkoutExisiting(final Resource resource) {
