...
public class CopyActionHttpv2 implements Action<Void> {
    ...
    public CopyActionHttpv2(final RepositoryInternal repository, final TransactionInternal transaction, final Resource sourceResource, final Revision sourceRevision, final Resource targetResource, final boolean createMissingParents) {
