...
public class QualifiedRegisterResourceActionHttpv1 implements Action<QualifiedResource> {
    ...
    public QualifiedRegisterResourceActionHttpv1(final RepositoryInternal repository, final QualifiedResource qualifiedResource, final Revision revision) {
    ...
    public QualifiedResource perform() {
        ...
        final Resource base = Resource.create(prefix + Resource.SEPARATOR + "ver" + Resource.SEPARATOR + revision);
