...
public class QualifiedVersionedResourceActionHttpv1 implements Action<QualifiedResource> {
    ...
    public QualifiedVersionedResourceActionHttpv1(final ReadOnlyRepositoryInternal repository, final QualifiedResource qualifiedResource, final Revision revision) {
    ...
    public QualifiedResource perform() {
        ...
        final Resource base = Resource.create(prefix + Resource.SEPARATOR + "bc" + Resource.SEPARATOR + revision);
