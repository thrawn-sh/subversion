 ...
 * XML in general does not allow such names. The methods in this class make sure these
 * properties can be read and written by default XML tool by escaping them before the XML processing and
 * reverting the escaping afterwards.
 */
